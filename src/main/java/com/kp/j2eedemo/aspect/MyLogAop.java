package com.kp.j2eedemo.aspect;

import com.alibaba.fastjson.JSON;
import com.kp.j2eedemo.bll.impl.Log.DoLogServiceimpl;
import com.kp.j2eedemo.entity.KesunReturn;
import com.kp.j2eedemo.entity.Log;
...
public class MyLogAop {
    ...
    @Pointcut(value="execution(* com.kp.j2eedemo.bll.impl.*.*(..))")
